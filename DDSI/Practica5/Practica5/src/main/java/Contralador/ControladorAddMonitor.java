...
public class ControladorAddMonitor {
    ...
    * 
    */
    public ControladorAddMonitor(Frame parent, Session con) {
    ...
    * 
    */
    public ControladorAddMonitor(Frame parent, Session con, Monitor m) {
        this.mDAO = new MariaMonitorDAO(con);
        this.vaddMonitor = new VistaAddMonitor(parent, true);
        this.vAddMonitorListener = (ActionEvent e) -> actionPerformedMonitor(e);
        this.placeHolder = m;
    ...
    public void setPlaceHolder(){
        this.vaddMonitor.CodeTextBox.setText(this.placeHolder.getCodmonitor());
